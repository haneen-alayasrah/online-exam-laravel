...
class MainController extends Controller
{
    ...
    public function quiz($slug){
        $quiz = Quiz::whereSlug($slug)->with('questions.my_answer','my_result')->first() ?? abort(404, "Quiz not foundı");
    ...
    public function result(Request $request, $slug){
        ...
        return redirect()->route('quiz.detail',$quiz->slug)->withSuccess("Quiz completed. your score: ".$points);
    }
