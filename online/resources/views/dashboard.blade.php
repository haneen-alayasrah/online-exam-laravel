        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header" style="text-align: center">
                    <i class="far fa-chart-bar"></i> Your Quiz Results
                </div>
                <ul class="list-group list-group-flush">
                    ...
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation"></i> You have not taken any quizzes yet. Choose a quiz from the left field and start testing your knowledge!
                    </div>
                    @else
